...
//logger.debug('error', 'Hello log files!');



//[ {"id":1,"domain":"google.com","scannerRequest":"https://www.google.com","badString":null,"goodString":"Google Inc.","status":200},{"id":1,"domain":"msn.com","scannerRequest":"https://www.msn.com","badString":null,"goodString":"MSNAvailToken","status":200}])};
let targets = ()=>{logger.debug("loading targets"); return Promise.resolve(
    [{"id":1,
        "domain":"www.bet365.com",
         "url":"https://www.bet365.com/defaultapi/sports-configuration",
         "headers":{},
         "cookies":[],
         "badString":" detected you are in a country that bet365",
         "goodString":"WebsiteConfig",
         "status":200
        },
        {"id":2,
         "domain":"www.marathonbet.com",
         "url":"https://www.marathonbet.com/en/live/popular?pageAction=default&_=1615806546272",
         "headers":{},
         "cookies":[],
         "badString":"Your IP address",
         "goodString":"marathonEventId",
         "status":200
        },
        {"id":2,
...
let proxies = ()=>{
    ...
    logger.debug("loading sources"); return Promise.resolve(rrr)};
let output = ()=>{console.log;};

let scanner = new Scanner(targets,proxies,output,{minq:150,parallel: 50,logLevel: 'info', logger:logger});//, logger
scanner.start();
//console.log(scanner);
